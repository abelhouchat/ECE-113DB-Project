...
As explained in \Cref{tab:implementation}, LibROSA is a more modern library for audio processing that is still maintained as opposed to the deprecated MATLAB libraries we found.
...
For example, the major C has pitch contributions from the C, E, and G pitch classes as we can see in \Cref{fig:chroma}.
\begin{figure}[t]
    \centering
